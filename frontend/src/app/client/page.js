  ...
  return (
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        {[
          { icon: Search, title: "Find Services", desc: "Search by location and budget", href: "/client/search", color: "from-blue-500 to-indigo-600" },
          { icon: DollarSign, title: "Cost Estimate", desc: "AI-powered instant prediction", href: "/client/estimate", color: "from-emerald-500 to-teal-600" },
          { icon: BarChart3, title: "Track Project", desc: "Monitor progress in real-time", href: "/client/tracking", color: "from-purple-500 to-pink-600" },
        ].map((item, i) => (
