    ...
    <div className="space-y-6 max-w-7xl mx-auto">
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }}>
        <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-3">
          <div>
            <h2 className="text-xl font-bold text-slate-900 mb-1 flex items-center gap-2.5">
              <div className="w-9 h-9 rounded-xl gradient-primary flex items-center justify-center">
                <Building2 className="w-5 h-5 text-white" />
              </div>
              Real Estate Valuation ML Model (Legacy)
            </h2>
            <p className="text-xs text-slate-500">
              XGBoost Regressor model trained on Bengaluru House Price Dataset (Kaggle). Evaluates market flat price values, not actual raw material construction costs.
            </p>
          </div>
          <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-50 border border-emerald-200">
            <div className="w-1.5 h-1.5 rounded-full bg-emerald-500 animate-pulse" />
            <span className="text-xs font-semibold text-emerald-700">Real ML Model (R²=0.7467)</span>
          </div>
        </div>
      </motion.div>
