...
const features = [
  {
    ...
    desc: "Build a traceable estimate from quantities, local rates, material assumptions, and project location.",
    color: "from-emerald-500 to-teal-600",
  },
  {
    icon: <Clock className="w-6 h-6" />,
    title: "Milestone Tracking",
    desc: "Track planned and actual phase progress, delays, and expected completion dates.",
    color: "from-blue-500 to-indigo-600",
  },
  {
    icon: <Users className="w-6 h-6" />,
    title: "Contractor & Labour Management",
    desc: "Keep contractor assignments, workforce records, attendance, and work completed together.",
    color: "from-purple-500 to-pink-600",
  },
  {
    icon: <BarChart3 className="w-6 h-6" />,
    title: "Estimated vs Actual Costs",
    desc: "Compare BOQ estimates, approved RA bills, expenses, and budget variance in one dashboard.",
    color: "from-amber-500 to-orange-600",
  },
];

const stats = [
  { value: "3", label: "Scale configurations" },
  { value: "20+", label: "Core workflows" },
  { value: "INR", label: "India-ready billing" },
  { value: "Audit", label: "Traceable history" },
];
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
            ...
            <h1 className="text-5xl md:text-7xl font-black leading-tight tracking-tight mb-6">
              Build Smarter
              <br />
              <span className="gradient-text">with accountable project control</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-400 max-w-2xl mx-auto mb-10 leading-relaxed">
              Manage the full construction workflow from BOQ and procurement through RA billing, payment, compliance, and budget variance.
            </p>
          </motion.div>
